 ...
 * (/home/alok/.aws/credentials) where the sample code will load the credentials
 * from.
 * <p>
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    + "location (/home/alok/.aws/credentials), and is in valid format.",
                    e);
        }
...
//            s3.deleteBucket(bucketName);
    ...
    private static File createSampleFile() throws IOException {
        File file = File.createTempFile("sample", ".json");
        file.deleteOnExit();
        ...
        try (Writer writer = new OutputStreamWriter(new FileOutputStream(file))) {
            ...
            for (int index = 0; index < 100; index++) {
                array.put(new JSONObject(helper.createAnalysisJSON()));
            }
